...
export default function AdminDashboardLayout({ children }) {
  ...
  const menuItems = [
    ...
    { name: 'Job Board Audits', path: '/admin-dashboard/jobs', icon: Briefcase },
    { name: 'Certificates Verifier', path: '/admin-dashboard/certificates', icon: Award },
    { name: 'Growth Analytics', path: '/admin-dashboard/analytics', icon: Sparkles },
    { name: 'Security Audit Logs', path: '/admin-dashboard/logs', icon: ShieldAlert },
    { name: 'Platform Settings', path: '/admin-dashboard/settings', icon: Settings }
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0b0f19] text-gray-800 dark:text-gray-100 flex transition-colors duration-300">
      ...
      <aside className="hidden lg:flex flex-col w-72 bg-white dark:bg-[#111827] border-r border-gray-100 dark:border-gray-800 shrink-0">
        <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center space-x-3">
          <div className="w-10 h-10 bg-indigo-600/10 dark:bg-indigo-600/20 rounded-xl flex items-center justify-center">
        ...
        <div className="p-6 border-t border-gray-100 dark:border-gray-800 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-indigo-600/10 dark:bg-indigo-600/20 rounded-full flex items-center justify-center font-bold text-indigo-600">
                A
              </div>
              <div className="truncate max-w-[130px]">
                <h4 className="text-xs font-black text-gray-900 dark:text-white truncate">{user?.name || 'Admin'}</h4>
